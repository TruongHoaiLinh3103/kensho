        ...
        <div className="FreeTrialapp">
            ...
            <div className="maxWidth1200px FreeTrialapp-body">
                <div className="FreeTrialapp-body_item">
                    ...
                    <h2 data-aos="fade-right">We illuminate insights in the world's data</h2>
                </div>
                <div className="FreeTrialapp-body_item">
                    <div className="FreeTrialapp-body_item-title">
                        <h3 data-aos="fade-left">Start your free trial</h3>
                        <p data-aos="fade-left">Try out all of the services in Kensho's AI Toolkit!</p>
                    </div>
